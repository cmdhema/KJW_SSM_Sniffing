...
public class SelectSiteDBRequest extends GetDBRequest<NumberData>{

	public SelectSiteDBRequest(NumberData list, String flag) {
		super(list, flag);
	}
	...
	public boolean onExecuteQuery(SQLiteDatabase database, String query, NumberData result) {
		...
		Cursor cursor = database.rawQuery(DBScheme.selectSiteInfo(query), null);
