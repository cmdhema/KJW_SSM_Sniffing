...
public class SendSiteNetworkRequest extends PostNetworkRequest<NumberData>{

	private NumberData data;
	
	public SendSiteNetworkRequest(NumberData data) {
		super(data);
		this.data = data;
	}
	...
	public URL getServerURL() {
		try {
			return new URL(NetworkConstant.serverURL + "/site");
