...
public abstract class NetworkGetRequest<T> extends NetworkRequest {
	...
	public NetworkGetRequest(T data) {
		this.result = data;
	}
	...
	public interface OnGetMethodProcessListener<T> {
		public void onGetMethodProcessSuccess(NetworkGetRequest<T> request);
