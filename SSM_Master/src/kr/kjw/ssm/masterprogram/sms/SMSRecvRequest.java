...
public class SMSRecvRequest extends NetworkGetRequest<ArrayList<MasterData>>{

	private String query;
	public SMSRecvRequest(ArrayList<MasterData> data, String query) {
		super(data);
		this.query = query;
	}
	...
	public URL getServerURL() {
		try {
			return new URL(NetworkConstant.serverURL + "/info/smsrecv?num=" + query);
