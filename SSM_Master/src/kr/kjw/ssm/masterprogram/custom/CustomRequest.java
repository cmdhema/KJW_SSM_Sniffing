package kr.kjw.ssm.masterprogram.custom;
...
public class CustomRequest extends NetworkGetRequest<ArrayList<MasterData>> {

	private String query;
	
	public CustomRequest(ArrayList<MasterData> data, String query) {
		super(data);
		this.query = query;
	}
	...
	public URL getServerURL() {
		try {
			return new URL(NetworkConstant.serverURL + "/info/custom?num=" + query);
